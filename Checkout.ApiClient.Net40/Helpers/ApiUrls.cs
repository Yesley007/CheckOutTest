namespace Checkout
{
    public class ApiUrls
    {
        ...
        private static string _drinkDelete;
        private static string _drinkAdd;
        private static string _drinkUpdate;
        private static string _drinkGetAll;
        private static string _drinkGetDrink;
        private static string _drinkCustomSearch;
        ...
        public static string DrinkAdd
        {
            get
            {
                return _drinkAdd ??
              (_drinkAdd = string.Concat(AppSettings.DrinkBaseApiUri, "/drinkApi/addDrink"));
            }
        }
          

        public static string DrinkUpdate
        {
            get
            {
                return _drinkUpdate ??
              (_drinkUpdate = string.Concat(AppSettings.DrinkBaseApiUri, "/drinkApi/UpdateDrinkStock"));
            }
        }
           
        public static string DrinkDelete
        {
            get
            {
                return _drinkDelete ??
             (_drinkDelete = string.Concat(AppSettings.DrinkBaseApiUri, "/drinkApi/deleteDrink/{0}"));
            }
        }
            

        public static string DrinkGetDrink
        {
            get
            {
                return _drinkGetDrink ??
             (_drinkGetDrink = string.Concat(AppSettings.DrinkBaseApiUri, "/drinkApi/getDrink/{0}"));
            }
        }
            

        public static string DrinkGetAll
        {
            get
            {
                return _drinkGetAll ??
             (_drinkGetAll = string.Concat(AppSettings.DrinkBaseApiUri, "/drinkApi/getAllDrink"));
            }
        }
            
        public static string DrinkGetCustom
        {
            get
            {
                return _drinkCustomSearch ??
             (_drinkCustomSearch = string.Concat(AppSettings.DrinkBaseApiUri, "/drinkApi/CustomSearch?PageSize = {0} & PageNumber = {1}"));
            }
        }

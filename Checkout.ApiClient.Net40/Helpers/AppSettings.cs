...
namespace Checkout
{
    ...
    public sealed class AppSettings
    {
        ...
        private static string _baseDrinkApiUri;
        private const string _drinkLiveUrl = "https://drinks.com";
        private const string _drinkSandboxUrl = "http://dev.drinkapi.com";

        public static string DrinkBaseApiUri
        {
            get { return _baseDrinkApiUri; }
            set { _baseDrinkApiUri = value; }
        }
            ...
            set
            {
                switch (value)
                {
                    case CheckoutEnvironment.Live:
                        ...
                        _baseDrinkApiUri = _drinkLiveUrl;
                        break;
                    case CheckoutEnvironment.Sandbox:
                        _baseDrinkApiUri = _drinkSandboxUrl;
